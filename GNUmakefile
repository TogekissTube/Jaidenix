...
# Es altamente recomendable usar una herramienta personalizada para construir un kernel.
# Aquí estamos usando "cc" como un marcador de posición. Puede funcionar usando
# la toolchain del sistema host, pero esto no está garantizado.
...
# Estas son específicas de mi configuración, por favor modifíquelas!!!!
########################################################################
QEMU := /usr/bin/qemu-system-x86_64
GDB := /usr/bin/gdb
CMDNEWSCREEN := konsole
MNTDIR := /mnt/jaidenix
...
setup:
	...
	@echo target remote localhost:$(GDBPORT) >> debug.gdb
